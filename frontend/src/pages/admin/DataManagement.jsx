...
const DataManagement = () => {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      {/* Page Header & Tabs */}
      <header className="px-8 py-6 bg-white/50 backdrop-blur-sm sticky top-0 z-10">
        <div className="flex justify-between items-end mb-6">
          ...
          <button className="bg-black hover:bg-gray-800 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition-all shadow-lg shadow-gray-200">
            <Plus size={18} />
            <span>
              Add{" "}
